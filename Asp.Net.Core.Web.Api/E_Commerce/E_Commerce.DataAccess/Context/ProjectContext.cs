...
public class ProjectContext:DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=localhost,1433;Database=EcommerceDB2;User Id=sa;Password=StrongPassword123!;Encrypt=False;TrustServerCertificate=True;");
