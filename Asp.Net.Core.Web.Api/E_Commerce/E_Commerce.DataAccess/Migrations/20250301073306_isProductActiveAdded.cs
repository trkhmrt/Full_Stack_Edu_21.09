...
{
    /// <inheritdoc />
    public partial class isProductActiveAdded : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "productId", "productDescription", "productName", "productUnitPrice", "subCategoryId" },
                values: new object[,]
                {
                    { 1, "Ps5 Oyun Konsolu", "Playstation 5", 10000, 5 },
                    { 2, "Xbox Oyun Konsolu", "Xbox", 12000, 5 },
                    { 3, "Kışlık Su Geçirmez Bot", "Bot", 2000, 1 },
                    { 4, "Suya dayanıklı Çizme", "Çizme", 4500, 1 },
                    { 5, "Ekoseli Gömlek", "Gömlek", 600, 2 },
                    { 6, "Boğazlı Kazak", "Kazak", 670, 2 }
                });
